...
) ENGINE=MyISAM AUTO_INCREMENT=9048 DEFAULT CHARSET=utf8");
...
E_D("replace into `ecs_shop_config` values('101','1','shop_name','text','','','测试网站','1');");
E_D("replace into `ecs_shop_config` values('102','1','shop_title','text','','','测试网站','1');");
E_D("replace into `ecs_shop_config` values('103','1','shop_desc','text','','','汇丰石化测试网站','1');");
E_D("replace into `ecs_shop_config` values('104','1','shop_keywords','text','','','汇丰石化测试网站','1');");
E_D("replace into `ecs_shop_config` values('105','1','shop_country','manual','','','a:6:{i:0;s:3:\"298\";i:1;s:3:\"284\";i:2;s:3:\"283\";i:3;s:2:\"52\";i:4;s:3:\"299\";i:5;s:3:\"285\";}','1');");
E_D("replace into `ecs_shop_config` values('108','1','shop_address','text','','','','1');");
E_D("replace into `ecs_shop_config` values('109','1','qq','text','','','1684567642','1');");
...
E_D("replace into `ecs_shop_config` values('114','1','service_email','text','','','1684567242@qq.com','1');");
...
E_D("replace into `ecs_shop_config` values('9040','2','account_amount','text','','','102','1');");
E_D("replace into `ecs_shop_config` values('9039','2','face_value','text','','','100','1');");
E_D("replace into `ecs_shop_config` values('9041','2','vip_face_value','text','','','1000','1');");
E_D("replace into `ecs_shop_config` values('9042','2','vip_account_amount','text','','','1150','1');");
E_D("replace into `ecs_shop_config` values('9043','2','seller_arrival','text','','','1.03','1');");
E_D("replace into `ecs_shop_config` values('9044','2','seller_vip_arrival','text','','','1.16','1');");
E_D("replace into `ecs_shop_config` values('9045','2','seller_cash','text','','','0.2','1');");
E_D("replace into `ecs_shop_config` values('9046','2','seller_deposit_min','text','','','1000','1');");
E_D("replace into `ecs_shop_config` values('9047','2','seller_deposit_percent','text','','','1.15','1');");
