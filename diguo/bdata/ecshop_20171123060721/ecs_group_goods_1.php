...
E_D("replace into `ecs_group_goods` values('0','10','88.00','1','0');");
E_D("replace into `ecs_group_goods` values('0','11','26.00','1','0');");
E_D("replace into `ecs_group_goods` values('0','47','130.00','1','0');");
