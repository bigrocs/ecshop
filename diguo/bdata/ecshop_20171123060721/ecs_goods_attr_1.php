...
E_D("replace into `ecs_goods_attr` values('10','0','211','500克','0','','','','');");
E_D("replace into `ecs_goods_attr` values('11','0','211','1000克','50','','','','');");
E_D("replace into `ecs_goods_attr` values('12','0','211','2000克','100','','','','');");
E_D("replace into `ecs_goods_attr` values('13','0','214','红色','','','','','');");
E_D("replace into `ecs_goods_attr` values('14','0','214','蓝色','','','','','');");
E_D("replace into `ecs_goods_attr` values('15','0','214','绿色','','','','','');");
E_D("replace into `ecs_goods_attr` values('16','0','215','时尚款','','','','','');");
E_D("replace into `ecs_goods_attr` values('17','0','215','经典款','','','','','');");
E_D("replace into `ecs_goods_attr` values('18','0','215','出众款','','','','','');");
