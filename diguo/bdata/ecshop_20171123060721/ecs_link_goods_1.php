...
E_D("replace into `ecs_link_goods` values('0','2','1','1');");
E_D("replace into `ecs_link_goods` values('0','4','1','1');");
E_D("replace into `ecs_link_goods` values('0','6','1','1');");
E_D("replace into `ecs_link_goods` values('2','0','1','1');");
E_D("replace into `ecs_link_goods` values('4','0','1','1');");
E_D("replace into `ecs_link_goods` values('6','0','1','1');");
