...
E_C("CREATE TABLE `ecs_shipping` (
  ...
  `support_pickup` tinyint(1) DEFAULT NULL,
  `supplier_id` int(11) unsigned DEFAULT '0',
  `is_default_show` tinyint(1) unsigned DEFAULT '0',
  PRIMARY KEY (`shipping_id`),
  KEY `shipping_code` (`shipping_code`,`enabled`)
) ENGINE=MyISAM AUTO_INCREMENT=8 DEFAULT CHARSET=utf8");
E_D("replace into `ecs_shipping` values('1','cac','上门取货','买家自己到商家指定地点取货','0','1','1','','','','2','0',NULL,NULL,NULL);");
E_D("replace into `ecs_shipping` values('2','fpd','运费到付','所购商品到达即付运费','0','0','1','','','','2','0',NULL,NULL,NULL);");
