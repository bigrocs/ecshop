...
E_D("replace into `ecs_account_log` values('28','12','0.00','0.00','156','156','1510701021','订单 2017111563274 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('29','12','0.00','0.00','-156','-156','1510701372','由于退货或未发货操作，退回订单 2017111563274 赠送的积分','99');");
E_D("replace into `ecs_account_log` values('30','12','0.00','0.00','156','156','1510701399','订单 2017111563274 赠送的积分','99');");
