...
E_D("replace into `ecs_adsense` values('16','wap站','4');");
...
E_D("replace into `ecs_adsense` values('9','wap站','3');");
...
E_D("replace into `ecs_adsense` values('10','pc站','2');");
E_D("replace into `ecs_adsense` values('4','wap站','3');");
E_D("replace into `ecs_adsense` values('6','wap站','1');");
E_D("replace into `ecs_adsense` values('1','wap站','5');");
