...
E_D("replace into `ecs_keywords` values('2017-12-30','ecshop','充值卡','2');");
E_D("replace into `ecs_keywords` values('2017-12-30','ecshop','茶','4');");
E_D("replace into `ecs_keywords` values('2018-01-02','ecshop','酒','2');");
E_D("replace into `ecs_keywords` values('2018-01-02','ecshop','红茶','7');");
E_D("replace into `ecs_keywords` values('2018-01-02','ecshop','茶叶','6');");
E_D("replace into `ecs_keywords` values('2018-01-02','ecshop','玩具','4');");
E_D("replace into `ecs_keywords` values('2018-01-02','ecshop','茶','2');");
E_D("replace into `ecs_keywords` values('2018-01-02','ecshop','普洱','2');");
E_D("replace into `ecs_keywords` values('2018-01-02','ecshop','橄榄油','2');");
E_D("replace into `ecs_keywords` values('2018-01-03','ecshop','苹果','2');");
E_D("replace into `ecs_keywords` values('2018-01-03','ecshop','酒','1');");
E_D("replace into `ecs_keywords` values('2018-01-03','ecshop','怀庄','1');");
E_D("replace into `ecs_keywords` values('2018-01-03','ecshop','郎酒','1');");
E_D("replace into `ecs_keywords` values('2018-01-03','ecshop','橘子','1');");
E_D("replace into `ecs_keywords` values('2018-01-08','ecshop','花生油','2');");
