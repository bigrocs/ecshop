...
E_D("replace into `ecs_account_seller_log` values('163','20','19','485.44','0.00','1514504179','加油收入-山东航宇','1');");
E_D("replace into `ecs_account_seller_log` values('164','20','23','38.83','0.00','1514573634','加油收入-静','1');");
E_D("replace into `ecs_account_seller_log` values('165','20','28','97.09','0.00','1514573644','加油收入-孙杰','1');");
E_D("replace into `ecs_account_seller_log` values('166','20','19','97.09','0.00','1514573646','加油收入-山东航宇','1');");
E_D("replace into `ecs_account_seller_log` values('167','20','26','48.54','0.00','1514573682','加油收入-l813731770','1');");
E_D("replace into `ecs_account_seller_log` values('168','20','24','48.54','0.00','1514573698','加油收入-ppp','1');");
E_D("replace into `ecs_account_seller_log` values('169','31','33','97.09','0.00','1514651264','加油收入-涛','1');");
E_D("replace into `ecs_account_seller_log` values('170','30','33','97.09','0.00','1514652020','加油收入-涛','1');");
E_D("replace into `ecs_account_seller_log` values('171','30','37','97.09','0.00','1514655071','加油收入-love','1');");
E_D("replace into `ecs_account_seller_log` values('172','30','37','97.09','0.00','1514655110','加油收入-love','1');");
E_D("replace into `ecs_account_seller_log` values('173','31','36','97.09','0.00','1514655234','加油收入-丁铭','1');");
E_D("replace into `ecs_account_seller_log` values('174','30','33','97.09','0.00','1514655568','加油收入-涛','1');");
E_D("replace into `ecs_account_seller_log` values('175','12','12','97.09','0.00','1514758431','加油收入-bvbv01','1');");
E_D("replace into `ecs_account_seller_log` values('176','12','12','97.09','0.00','1514758505','加油收入-bvbv01','1');");
E_D("replace into `ecs_account_seller_log` values('177','12','12','97.09','0.00','1514758519','加油收入-bvbv01','1');");
E_D("replace into `ecs_account_seller_log` values('178','12','12','97.09','0.00','1514848308','加油收入-bvbv01','1');");
E_D("replace into `ecs_account_seller_log` values('179','20','48','97.09','0.00','1515351248','加油收入-嘎嘣','1');");
E_D("replace into `ecs_account_seller_log` values('180','20','46','86.21','0.00','1515351253','加油收入-15853340625','1');");
E_D("replace into `ecs_account_seller_log` values('181','20','42','485.44','0.00','1515351262','加油收入-风云','1');");
E_D("replace into `ecs_account_seller_log` values('182','20','56','97.09','0.00','1515351274','加油收入-杨鹏','1');");
E_D("replace into `ecs_account_seller_log` values('183','20','26','97.09','0.00','1515351297','加油收入-l813731770','1');");
E_D("replace into `ecs_account_seller_log` values('184','20','49','97.09','0.00','1515351324','加油收入-april','1');");
E_D("replace into `ecs_account_seller_log` values('185','20','33','86.21','0.00','1515351353','加油收入-涛','1');");
