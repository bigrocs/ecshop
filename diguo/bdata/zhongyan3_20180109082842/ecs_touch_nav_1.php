...
E_D("replace into `ecs_touch_nav` values('2','a','3','帮助中心','0','0','0','article_cat.php?id=3','1448075935109557161.png','middle');");
E_D("replace into `ecs_touch_nav` values('3','','0','个人中心','0','0','0','user.php','1443584373727011961.png','middle');");
E_D("replace into `ecs_touch_nav` values('4','','0','分销中心','0','0','0','distribute.php','1443586488909704319.png','middle');");
E_D("replace into `ecs_touch_nav` values('5','','0','联系我们','0','0','0','ectouch.php?act=contact','1443586300343329180.png','middle');");
