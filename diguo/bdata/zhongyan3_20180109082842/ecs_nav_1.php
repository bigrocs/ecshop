...
E_D("replace into `ecs_nav` values('4','c','1','酒水饮品','1','2','0','category.php?id=1','middle');");
...
E_D("replace into `ecs_nav` values('12','c','142','润滑油','1','6','0','category.php?id=142','middle');");
E_D("replace into `ecs_nav` values('14','c','5','粮油调味','1','8','0','category.php?id=5','middle');");
