...
if ($_REQUEST['step'] == 'add_to_cart') {
    ...
    $result['picktxt'] = "<input type='hidden' id='point".$suppid."' name='pickup_point[".$suppid."]' value='".$info['id']."'><span style='color:#F30'>自提点：</span><span>".$info['shop_name']."</span><a href='javascript:void(0);' onclick='show(\"pop\",".$suppid.")' style='color:#F30;margin-left:40px'>修改</a>";
    echo $json->encode($result);
    exit;
