...
if ($_REQUEST['act'] == 'list_edit') {
    ...
    if ($_CFG['shop_country']) {
        $_CFG['shop_country'] = unserialize($_CFG['shop_country']);
        foreach ($_CFG['shop_country'] as $key => $value) {
            $_CFG['shop_countrys'][$value] = get_region_name($value);
        }
    }
