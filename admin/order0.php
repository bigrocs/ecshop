...
//                    if (empty($value['extension_code']) || $value['extension_code'] == 'virtual_card')
                        if (empty($value['extension_code']) || $value['extension_code'] == 'virtual_card' || $value['extension_code'] == 'pre_sale') /* 代码修改 By  www.68ecshop.com End */
                    {
...
} elseif ($_REQUEST['act'] == 'get_tc_express') {
    require_once(ROOT_PATH . 'includes/cls_json.php');
    $json = new JSON;
