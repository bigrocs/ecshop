...
$_LANG['seller_center'] = '卖家中心';

$_LANG['seller_order'] = '订单列表';
$_LANG['seller_info'] = '信息管理';
$_LANG['affiliated_company'] = '您的所属公司';
$_LANG['seller_capital'] = "可用资金";
$_LANG['seller_jurisdiction'] = '对不起,您没有卖家管理权限';
$_LANG['seller_user'] = '跳转会员中心';
$_LANG['last_time'] = '您的上一次登录时间';
$_LANG['seller_corporate'] = '公司名称';
$_LANG['seller_bank'] = '银行';
$_LANG['seller_bank_name'] = '收款人';
$_LANG['seller_bank_account'] = '银行账号';
$_LANG['seller_edit_info'] = '保存成功';
$_LANG['seller_log'] = '资金记录';
$_LANG['seller_gas'] = '加油二维码';
$_LANG['seller_deposit'] = '商家充值';
$_LANG['seller_cash'] = '商家提现';
