...
$_LANG['cfg_name']['seller_kuaibi_deposit'] = '商家充值储值卡';
$_LANG['cfg_name']['message_board'] = '是否启用留言板功能';
$_LANG['cfg_name']['message_check'] = '用户留言是否需要审核';
$_LANG['cfg_name']['face_value'] = '充值卡面额';
$_LANG['cfg_name']['account_amount'] = '充值卡到账余额';
$_LANG['cfg_name']['vip_face_value'] = 'VIP充值卡金额';
$_LANG['cfg_name']['vip_account_amount'] = 'VIP充值卡到账余额';
$_LANG['cfg_name']['seller_arrival'] = '余额商家到账除以这个比例';
$_LANG['cfg_name']['seller_vip_arrival'] = 'VIP余额商家到账除以这个比例';
$_LANG['cfg_name']['seller_cash'] = '卖家提现手续费（百分比）';
$_LANG['cfg_name']['seller_deposit_min'] = '卖家VIP充值最低金额';
$_LANG['cfg_name']['seller_deposit_percent'] = '卖家VIP充值扣费比例（充值金额／比例）';
...
$_LANG['cfg_range']['seller_kuaibi_deposit']['1'] = '开启';
$_LANG['cfg_range']['seller_kuaibi_deposit']['0'] = '关闭';
