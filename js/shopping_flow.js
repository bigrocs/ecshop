...
{
    if (document.getElementById('picktxt')&&result.picktxt) {
        document.getElementById('picktxt').innerHTML = result.picktxt;
    }else{
        document.getElementById('picktxt').innerHTML = '';
    }
