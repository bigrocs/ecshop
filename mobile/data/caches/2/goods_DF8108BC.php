<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:65:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/goods.dwt";i:1;s:76:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:79:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1517039118;s:8:"maketime";i:1517035518;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>滋源生姜中干护发素535ml_护发素_洗发护发_美妆洗化_汇丰石化测试网站 触屏版</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="images/201801/thumb_img/539_thumb_G_1516320816996.jpg"  alt="滋源生姜中干护发素535ml" /></a></div>-->
      <ul>
                              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/539_P_1516320816474.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/539_P_1516320851899.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(539)" style="display: inline;"></a>
  <div class="title">
    <h1> 滋源生姜中干护发素535ml </h1>
  </div>
    <div class="title">
      </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>128.00</span></b>　    <del>原价：￥<span>129.90</span></del>
    </li>
    	  </ul>
  <ul>
      <li>可用储值卡:<b class="price" id="ECS_SHOP_JIUBI">31.00</b></li>
  </ul>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(539)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
...
var myString=new Array();
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(539)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(539);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://zy.jianzhanzhuanjia.net/images/201801/source_img/539_G_1516320816265.jpg"> </div>
            <div id="right">
              <p>滋源生姜中干护发素535ml</p>
  ...
  <table>
    ...
    <div class="desc wrap">
      <div class="blank2"></div>
	  		<p><img src="http://zy.jianzhanzhuanjia.net/images/upload/Image/1111(10).jpg" alt="" />&nbsp;</p>	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:539;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    ...
    timestamp: 1517035518,
    nonceStr: 'wciZV3okEQQkIBGa',
    signature: '7b7633310c75e4a718cfa4faee40d314cbd22338',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '滋源生姜中干护发素535ml',
      desc: '滋源生姜中干护发素535ml',
      link: '',
      imgUrl: 'http://zy.jianzhanzhuanjia.net/images/201801/source_img/539_G_1516320816265.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(539)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(539);">加入购物车</button>
