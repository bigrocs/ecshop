<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:65:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/goods.dwt";i:1;s:76:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:79:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1516944975;s:8:"maketime";i:1516941375;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>三本便携式压缩洁面巾（4枚入）_美妆日用_美妆洗化_汇丰石化测试网站 触屏版</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="images/201801/thumb_img/582_thumb_G_1516558703999.jpg"  alt="三本便携式压缩洁面巾（4枚入）" /></a></div>-->
      <ul>
                              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://www.sdhfshxs.com/images/201801/goods_img/582_P_1516558703286.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://www.sdhfshxs.com/images/201801/goods_img/582_P_1516558714245.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(582)" style="display: inline;"></a>
  <div class="title">
    <h1> 三本便携式压缩洁面巾（4枚入） </h1>
  </div>
    <div class="title">
      </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>15.00</span></b>　    <del>原价：￥<span>15.00</span></del>
    </li>
    	  </ul>
  <ul>
...
var myString=new Array();
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(582)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(582);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://www.sdhfshxs.com/images/201801/source_img/582_G_1516558703383.jpg"> </div>
            <div id="right">
              <p>三本便携式压缩洁面巾（4枚入）</p>
  ...
  <table>
    ...
    <div class="desc wrap">
      <div class="blank2"></div>
	  		<p><img src="http://www.sdhfshxs.com/images/upload/Image/222(5).jpg" alt="" />&nbsp;</p>	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:582;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    ...
    timestamp: 1516941375,
    nonceStr: 'EMZ4BLQLq1ziEj5f',
    signature: 'b7f4ac0129ebeb3c4def226b5884fd775ee2b989',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '三本便携式压缩洁面巾（4枚入）',
      desc: '三本便携式压缩洁面巾（4枚入）',
      link: '',
      imgUrl: 'http://www.sdhfshxs.com/images/201801/source_img/582_G_1516558703383.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(582)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(582);">加入购物车</button>
