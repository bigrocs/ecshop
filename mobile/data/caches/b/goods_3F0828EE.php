<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:52:"/var/www/ecshop/mobile/themes/ocailong_com/goods.dwt";i:1;s:63:"/var/www/ecshop/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:66:"/var/www/ecshop/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1511412290;s:8:"maketime";i:1511408690;}<!DOCTYPE html>
<html>
<head>
...
spec_arr = getSelectedAttributes(frm);
    if(spec_arr==''){
         document.getElementById('shows_number').innerHTML = '65534件';
    }else{
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      ...
      <ul>
                              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/1_P_1449024889287.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/1_P_1449024889264.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/1_P_1449024889889.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/1_P_1449024889726.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/1_P_1449024889018.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  ...
  <div class="title">
    ...
    <div class="title">
    食用百香果可以增加胃部饱腹感，减少余热量的摄入，还可以吸附胆固醇和胆汁之类有机分子，抑制人体对脂肪的吸收。因此，长期食用有利于改善人体营养吸收结构，降低体内脂肪，塑造健康优美体态。  </div>
  <ul>
        <li>促销价：<b class="price">￥<span>156</span></b>　    <del>￥<span>232</span></del>
    </li>
    	    <li>
	注册用户：<b class="price" >￥<span>193</span></b></li>
  </ul>
     ...
     <div class="fields"   style="display: block;">
		...
		<h2>款式：</h2>
		      ...
		      <p class="padd" title="时尚款">
		      		      <img src="http://ecshop.dev/images/201512/thumb_img/1_thumb_G_1449025104251.jpg" width="40" height="40" alt="时尚款">
		                            <i></i>
                      </p>
		      ...
		      <p class="padd" title="经典款">
		      		      <img src="http://ecshop.dev/images/201512/thumb_img/1_thumb_G_1449025115783.jpg" width="40" height="40" alt="经典款">
		                            <i></i>
                      </p>
		      ...
		      <p class="padd" title="出众款">
		      		      <img src="http://ecshop.dev/images/201512/thumb_img/1_thumb_G_1449025126133.jpg" width="40" height="40" alt="出众款">
		                            <i></i>
                      </p>
...
myString[26]="|3|6|9|";
	   ...
	   <span class="ui-number radius5" style="float:left;">
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="65534" type="text" />
	 ...
	 <!--
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://ecshop.dev/images/201512/source_img/1_G_1449024889141.jpg"> </div>
            <div id="right">
              <p>新鲜水果甜蜜香脆单果约800克</p>
  ...
  <table>
    ...
    <div class="desc wrap">
      <div class="blank2"></div>
	  		<p><img width="790" height="441" src="http://ecshop.dev/images/upload/Image/1(1).jpg" alt="" /><br />
<img width="790" height="595" src="http://ecshop.dev/images/upload/Image/2.jpg" alt="" /><br />
<img width="790" height="602" src="http://ecshop.dev/images/upload/Image/3.jpg" alt="" /></p>	      </div>
  </div>
  ...
  <div id="tab3" class="hidden">
    <div class="wrap">
      <ul class="m-recommend ">
        <div class="blank2"></div>
                <li class="flex_in  "    > <a href="goods.php?id=2&u=12">
        <div class="summary radius5"> <img src="http://ecshop.dev/images/201512/thumb_img/2_thumb_G_1448945810147.jpg" alt=""/>
          <div class="price">
                        ￥<span>88</span>            
          </div>
        </div>
                ...
                <li class="flex_in  "    style="float:right"  > <a href="goods.php?id=4&u=12">
        <div class="summary radius5"> <img src="http://ecshop.dev/images/201512/thumb_img/4_thumb_G_1448945381841.jpg" alt=""/>
          <div class="price">
                        ￥<span>75</span>            
          </div>
        </div>
                ...
                <li class="flex_in  "    > <a href="goods.php?id=6&u=12">
        <div class="summary radius5"> <img src="http://ecshop.dev/images/201512/thumb_img/6_thumb_G_1448945167914.jpg" alt=""/>
          <div class="price">
                        ￥<span>199</span>            
          </div>
        </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1511408691,
    nonceStr: 'M7jYbwxxE2lFyLOd',
    signature: '43f4fc0882c0c0ef3085293d8b1de5d2d6bf7a55',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      imgUrl: 'http://ecshop.dev/images/201512/source_img/1_G_1449024889141.jpg',
