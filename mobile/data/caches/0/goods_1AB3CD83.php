<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:65:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/goods.dwt";i:1;s:76:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:79:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1515393166;s:8:"maketime";i:1515389566;}<!DOCTYPE html>
<html>
<head>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(297)" style="display: inline;"></a>
  <div class="title">
    <h1> 茶语仙-818冻顶老茶王 </h1>
  </div>
    <div class="title">
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <form action="javascript:addToCart(297)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
...
var myString=new Array();
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(297)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(297);">
...
.spxq_main table td div, .spxq_main table td span {
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:297;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1515389566,
    nonceStr: 'Y8yJt4gMiZ9F65JO',
    signature: '8dc755b9740cf92bc6b450a7bd5429fd282b39a2',
    jsApiList: [
        'onMenuShareTimeline',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(297)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(297);">加入购物车</button>
