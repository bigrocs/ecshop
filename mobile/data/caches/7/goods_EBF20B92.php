<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:52:"/var/www/ecshop/mobile/themes/ocailong_com/goods.dwt";i:1;s:63:"/var/www/ecshop/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:66:"/var/www/ecshop/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1510901657;s:8:"maketime";i:1510898057;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>人头马CLUB特优香槟干邑350ml_洋酒_酒水饮料_ 触屏版</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="images/201512/thumb_img/51_thumb_G_1448946466261.jpg"  alt="人头马CLUB特优香槟干邑350ml" /></a></div>-->
      <ul>
                              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/51_P_1448946466208.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/51_P_1448946466595.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(51)" style="display: inline;"></a>
  <div class="title">
    <h1> 人头马CLUB特优香槟干邑350ml </h1>
  </div>
    <div class="title">
      </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>26</span></b>　    <del>￥<span>31</span></del>
    </li>
    	  </ul>
      <ul>
    <li>
        本商品正在进行        <a href="group_buy.php" title="团购活动" class="rule c333">[团购活动]</a>
        <a href="group_buy.php?act=view&amp;id=8" title="团购活动 喷香鸡肉棒美味鸡肉条垂涎欲滴500g的时间为2015-11-25到2022-11-29，赶快来抢吧！" class="rule c333">喷香鸡肉棒美味鸡肉条垂涎欲滴500g</a><br />
...
var myString=new Array();
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(51)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(51);">
        ...
        <div class="sellerPopGeneral" id="sellerDiv" >
          ...
          <div id="main">
            <p>这里是厂家信息的输入 2017.11.16</p>
<p><img src="/images/upload/Image/1(1).jpg" width="100%" alt="" /><br />
<img src="/images/upload/Image/2.jpg" width="100%" alt="" /><br />
<img src="/images/upload/Image/3.jpg" width="100%" alt="" /></p>          </div>
        </div>
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://ecshop.dev/images/201512/source_img/51_G_1448946466769.jpg"> </div>
            <div id="right">
              <p>人头马CLUB特优香槟干邑350ml</p>
...
<img width="790" height="602" src="http://ecshop.dev/images/upload/Image/3.jpg" alt="" /></p>	      </div>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:51;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1510898057,
    nonceStr: 'IZwUOHrxZ97GSCH4',
    signature: 'aac5f66853883f9183ef8c6679d70c5dc7f9d8da',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '人头马CLUB特优香槟干邑350ml',
      link: '',
      imgUrl: 'http://ecshop.dev/images/201512/source_img/51_G_1448946466769.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(51)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(51);">加入购物车</button>
    <div class="countdown"> <span class="label"></span><span class="time"></span></div>
    <a href="flow.php?step=cart" class="cart-link" title="购物车"></a>
</section>
<script type="text/javascript">
        function sellerShowDiv(){
        document.getElementById('sellerDiv').style.display = 'block';
        document.getElementById('hidDiv').style.display = 'block';
    }
    function sellerCloseDiv(){
