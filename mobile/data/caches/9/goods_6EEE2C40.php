<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:65:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/goods.dwt";i:1;s:76:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:79:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1517065224;s:8:"maketime";i:1517061624;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>雕牌除菌洗衣皂_洗衣皂_衣物清洁_美妆洗化_汇丰石化测试网站 触屏版</title>
...
spec_arr = getSelectedAttributes(frm);
    if(spec_arr==''){
         document.getElementById('shows_number').innerHTML = '49995件';
    }else{
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="images/201801/thumb_img/252_thumb_G_1515088418481.jpg"  alt="雕牌除菌洗衣皂" /></a></div>-->
      <ul>
                              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/252_P_1515088418613.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/252_P_1515088418012.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/252_P_1515088418340.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/252_P_1515088418398.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/252_P_1515088419474.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(252)" style="display: inline;"></a>
  <div class="title">
    <h1> 雕牌除菌洗衣皂 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">￥<span>4.20</span></b>　    <del>原价：￥<span>4.20</span></del>
    </li>
    	  </ul>
  <ul>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <div>请选择<span>雕牌除菌洗衣皂</span><i></i></div>
     ...
     <div class="fields"   style="display: block;">
		...
		<h2>雕牌除菌洗衣皂：</h2>
                <div class="items">
                  ...
                  <input type="hidden" name="spec_attr_type" value="243">
                  <ul class="ys_xuan" id="xuan_243">
                    <div class="catt" id="catt_243">
                                            <a href="javascript:" class="cattsel" onclick="show_attr_status(this,252);" name="170" id="xuan_a_170">
		      <p style="padding:6px 10px;" title="176g">
		                            <em>176g</em>
                                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_170" type="radio" name="spec_243" value="170" checked />
                      </a>
                                            <a href="javascript:"  onclick="show_attr_status(this,252);" name="172" id="xuan_a_172">
		      <p style="padding:6px 10px;" title="202g">
		                            <em>202g</em>
                                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_172" type="radio" name="spec_243" value="172"  />
                      </a>
                                            <a href="javascript:"  onclick="show_attr_status(this,252);" name="171" id="xuan_a_171">
		      <p style="padding:6px 10px;" title="176g*2">
		                            <em>176g*2</em>
                                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_171" type="radio" name="spec_243" value="171"  />
                      </a>
                                            <a href="javascript:"  onclick="show_attr_status(this,252);" name="174" id="xuan_a_174">
		      <p style="padding:6px 10px;" title="242g">
		                            <em>242g</em>
                                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_174" type="radio" name="spec_243" value="174"  />
                      </a>
                                            <a href="javascript:"  onclick="show_attr_status(this,252);" name="173" id="xuan_a_173">
		      <p style="padding:6px 10px;" title="202g*2">
		                            <em>202g*2</em>
                                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_173" type="radio" name="spec_243" value="173"  />
                      </a>
                                          </div>
                  </ul>
...
myString[4]="|174|";
	   ...
	   <span class="ui-number radius5" style="float:left;">
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="49995" type="text" />
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(252)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(252);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://zy.jianzhanzhuanjia.net/images/201801/source_img/252_G_1515088418482.jpg"> </div>
            <div id="right">
              <p>雕牌除菌洗衣皂</p>
  ...
  <table>
    ...
    <div class="desc wrap">
      <div class="blank2"></div>
	  		<p><img src="http://zy.jianzhanzhuanjia.net/images/upload/Image/s/93/20170622_163054_083.jpg" width="740" height="778" alt="" /><img src="http://zy.jianzhanzhuanjia.net/images/upload/Image/s/93/20170622_163054_082.jpg" width="790" height="1107" alt="" /><img src="http://zy.jianzhanzhuanjia.net/images/upload/Image/s/93/20170622_163054_084.jpg" width="740" height="1046" alt="" /><img src="http://zy.jianzhanzhuanjia.net/images/upload/Image/s/93/20170622_163054_085.jpg" width="750" height="940" alt="" /></p>	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:252;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    ...
    timestamp: 1517061624,
    nonceStr: 'MkVrttOYDHjZ4AjJ',
    signature: 'c8b353db4481379c4305377ab5ba996a69f5a1f1',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '雕牌除菌洗衣皂',
      link: '',
      imgUrl: 'http://zy.jianzhanzhuanjia.net/images/201801/source_img/252_G_1515088418482.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(252)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(252);">加入购物车</button>
