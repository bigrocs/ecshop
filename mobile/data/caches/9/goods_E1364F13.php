<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:65:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/goods.dwt";i:1;s:76:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:79:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1516963595;s:8:"maketime";i:1516959995;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>怀庄53-神秘茅台_白酒_美酒_烟酒茶饮_汇丰石化测试网站 触屏版</title>
...
spec_arr = getSelectedAttributes(frm);
    if(spec_arr==''){
         document.getElementById('shows_number').innerHTML = '9979件';
    }else{
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="images/201711/thumb_img/202_thumb_G_1511572087353.jpg"  alt="怀庄53-神秘茅台" /></a></div>-->
      <ul>
                              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://www.sdhfshxs.com/images/201711/goods_img/202_P_1511572087315.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://www.sdhfshxs.com/images/201711/goods_img/202_P_1511572087602.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(202)" style="display: inline;"></a>
  <div class="title">
    <h1> 怀庄53-神秘茅台 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">￥<span>158.00</span></b>　    <del>原价：￥<span>398.00</span></del>
    </li>
    	    <li>
	注册用户：<b class="price" >￥<span>158.00</span></b></li>
  </ul>
  <ul>
      <li>可用储值卡:<b class="price" id="ECS_SHOP_JIUBI">89.00</b></li>
  </ul>
...
var myString=new Array();
	   ...
	   <span class="ui-number radius5" style="float:left;">
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="9979" type="text" />
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(202)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(202);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://www.sdhfshxs.com/images/201711/source_img/202_G_1511572087877.jpg"> </div>
            <div id="right">
              <p>怀庄53-神秘茅台</p>
  ...
  <table>
    ...
    <div class="desc wrap">
      <div class="blank2"></div>
	  		<p><img src="http://www.sdhfshxs.com/images/upload/Image/ding/shen%20mi%20mao%20tai/taotu.jpg" alt="" />&nbsp;</p>	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:202;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    ...
    timestamp: 1516959995,
    nonceStr: 'RJpUpFps5mk22gmR',
    signature: '936222c9d7ddae589dc8622aa87f9a7997244122',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      imgUrl: 'http://www.sdhfshxs.com/images/201711/source_img/202_G_1511572087877.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(202)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(202);">加入购物车</button>
