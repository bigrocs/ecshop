<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:65:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/goods.dwt";i:1;s:76:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:79:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1517039106;s:8:"maketime";i:1517035506;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>滋源无患子中干护发素(265ml/535ml)_护发素_洗发护发_美妆洗化_汇丰石化测试网站 触屏版</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="images/201801/thumb_img/536_thumb_G_1516319901280.jpg"  alt="滋源无患子中干护发素(265ml/535ml)" /></a></div>-->
      <ul>
                              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/536_P_1516319901120.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201801/goods_img/536_P_1516319926548.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(536)" style="display: inline;"></a>
  <div class="title">
    <h1> 滋源无患子中干护发素(265ml/535ml) </h1>
  </div>
    <div class="title">
      </div>
  <ul>
        <li>本店售价：<b class="price">￥<span>44.00</span></b>　    <del>原价：￥<span>45.90</span></del>
    </li>
    	  </ul>
  <ul>
      <li>可用储值卡:<b class="price" id="ECS_SHOP_JIUBI">10.00</b></li>
  </ul>
...
<div class="wrap">
  <section class="goodsBuy radius5">
    ...
    <div>请选择<span>滋源无患子中干护发素(265ml/535ml)</span><i></i></div>
    <div class="selected"> </div>
    </label>
    <form action="javascript:addToCart(536)" method="post" name="ECS_FORMBUY" id="ECS_FORMBUY" >
     <div class="fields"   style="display: block;">
        ...
        <ul class="ul2">
              		...
              		<li>
		<h2>滋源无患子中干护发素(265ml/535ml)：</h2>
                <div class="items">
                  
                                                      
                  <input type="hidden" name="spec_attr_type" value="397">
                  <ul class="ys_xuan" id="xuan_397">
                    <div class="catt" id="catt_397">
                                            <a href="javascript:" class="cattsel" onclick="show_attr_status(this,536);" name="490" id="xuan_a_490">
		      <p style="padding:6px 10px;" title="265ml">
		                            <em>265ml</em>
                                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_490" type="radio" name="spec_397" value="490" checked />
                      </a>
                                            <a href="javascript:"  onclick="show_attr_status(this,536);" name="491" id="xuan_a_491">
		      <p style="padding:6px 10px;" title="535ml">
		                            <em>535ml</em>
                                            <i></i>
                      </p>
                      <input style="display:none" id="spec_value_491" type="radio" name="spec_397" value="491"  />
                      </a>
                                          </div>
                  </ul>
...
myString[1]="|491|";
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(536)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(536);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://zy.jianzhanzhuanjia.net/images/201801/source_img/536_G_1516319901679.jpg"> </div>
            <div id="right">
              <p>滋源无患子中干护发素(265ml/535ml)</p>
  ...
  <table>
    ...
    <div class="desc wrap">
      <div class="blank2"></div>
	  		<p><img src="http://zy.jianzhanzhuanjia.net/images/upload/Image/1111(9).jpg" alt="" />&nbsp;</p>	      </div>
  </div>
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:536;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    ...
    timestamp: 1517035506,
    nonceStr: '1pJC7jQJqhn4zSOC',
    signature: '7b2b56d7205c1129f6326eb0789dec6f21e7763f',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '滋源无患子中干护发素(265ml/535ml)',
      desc: '滋源无患子中干护发素(265ml/535ml)',
      link: '',
      imgUrl: 'http://zy.jianzhanzhuanjia.net/images/201801/source_img/536_G_1516319901679.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(536)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(536);">加入购物车</button>
