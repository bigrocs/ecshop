<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:68:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/category.dwt";i:1;s:78:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/goods_list.lbi";i:2;s:79:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1516944961;s:8:"maketime";i:1516941361;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>美妆洗化_汇丰石化测试网站 触屏版</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <div class="categoryleve clearfix"><span>分类：</span>
									<a  href="category.php?id=139">口腔护理</a>
							<a  href="category.php?id=140">面部护理</a>
							<a  href="category.php?id=141">衣物清洁</a>
							<a  href="category.php?id=182">厨卫清洁</a>
							<a  href="category.php?id=171">沐浴清洁</a>
							<a  href="category.php?id=159">洗发护发</a>
							<a  href="category.php?id=199">儿童护理</a>
							<a  href="category.php?id=202">韩束专区</a>
							<a  href="category.php?id=204">美妆日用</a>
							<a  href="category.php?id=213">相宜本草</a>
					</div>
<div class="filter" style="position:static; top:0px; width:100%;">
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=132&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list">销量 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb f-ico-triangle-slctd"></i> </span> </a> </li>
      <li class=""> <a href="category.php?category=132&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      <li class=""> <a href="category.php?category=132&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class="filter-cur"> <a href="category.php?category=132&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
                            ...
                            <a href="javascript:void(0);" data="0">全部</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="16">100年润发</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="17">纳爱斯</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="18">雕牌</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="20">超能</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="21">西丽</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="24">妙管家</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="26">阿道夫</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="33">NAK</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="35">瑷露德玛</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="37">滋源</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="38">青蛙王子</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="39">红贝缇</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="40">韩束</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="41">三本</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="42">面部清洁</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="43">FE金典牙医</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="44">Colgate高露洁</a></li>
                                    <li>
                            <a href="javascript:void(0);" data="47">相宜本草</a></li>
                        <input type="hidden" name="brand" value="0" />
          </ul>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=132&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/ocailong_com/images/loader.gif" /></div>'})
	$(window).scroll(function () {
