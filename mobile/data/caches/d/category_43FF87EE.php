<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:55:"/var/www/ecshop/mobile/themes/ocailong_com/category.dwt";i:1;s:65:"/var/www/ecshop/mobile/themes/ocailong_com/library/goods_list.lbi";i:2;s:66:"/var/www/ecshop/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1512275891;s:8:"maketime";i:1512272291;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta charset="utf-8" />
<title>生鲜食品_汇丰石化测试网站 触屏版</title>
...
<div id="page" style="right: 0px; left: 0px; display: block;">
  ...
  <div class="categoryleve clearfix"><span>分类：</span>
									<a  href="category.php?id=15">精品肉类</a>
							<a  href="category.php?id=16">海鲜水产</a>
							<a  href="category.php?id=17">蛋制品</a>
							<a  href="category.php?id=18">叶菜类</a>
							<a  href="category.php?id=19">根茎类</a>
							<a  href="category.php?id=20">茄果类</a>
							<a  href="category.php?id=21">菌菇类</a>
							<a  href="category.php?id=22">进口生鲜</a>
					</div>
<div class="filter" style="position:static; top:0px; width:100%;">
  <form method="GET" class="sort" name="listform">
    <ul class="filter-inner">
      <li class="filter-cur"> <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=ASC#goods_list">销量 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb f-ico-triangle-slctd"></i> </span> </a> </li>
      <li class=""> <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=DESC#goods_list">综合</a> </li>
      <li class=""> <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=click_count&order=DESC#goods_list">人气<i class="f-ico-arrow-d"></i></a> </li>
      <li class="filter-cur"> <a href="category.php?category=2&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">价格 <span> <i class="f-ico-triangle-mt "></i> <i class="f-ico-triangle-mb "></i> </span> </a> </li>
    ...
    <div class="attrs attr-fix" style="overflow: auto;height: 100%"> 
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="2">发育宝Haipet</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="3">雷米高</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="4">百利</a></li>
        ...
        <div class="attrValues">
          <ul class="av-collapse filter_list">
              ...
              <a href="javascript:void(0);" data="20|70">20&nbsp;-&nbsp;70</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="70|120">70&nbsp;-&nbsp;120</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="120|170">120&nbsp;-&nbsp;170</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="170|220">170&nbsp;-&nbsp;220</a></li>
             
                        <li> 
               
              <a href="javascript:void(0);" data="220|270">220&nbsp;-&nbsp;270</a></li>
                        <input type="hidden" name="price_min" value="0" />
            <input type="hidden" name="price_max" value="0" />
          </ul>
          <div class="av-options"><a class="j_More avo-more avo-more-down" href="javascript:;">查看更多<i></i></a> </div>
...
<script type="text/javascript">
jQuery(function($){
	$('#J_ItemList').more({'address': 'category.php?act=asynclist&category=2&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=sales_volume_base&order=DESC', 'spinner_code':'<div style="text-align:center; margin:10px;"><img src="themes/ocailong_com/images/loader.gif" /></div>'})
	$(window).scroll(function () {
