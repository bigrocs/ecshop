<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:65:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/goods.dwt";i:1;s:76:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:79:"D:/wwwroot/zhongyan3/wwwroot/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1515393774;s:8:"maketime";i:1515390174;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>西王花生油_食用油_粮油调味_生鲜食品_汇丰石化测试网站 触屏版</title>
...
spec_arr = getSelectedAttributes(frm);
    if(spec_arr==''){
         document.getElementById('shows_number').innerHTML = '9996件';
    }else{
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller">
      <!--<div><a href="javascript:showPic()"><img src="images/201711/thumb_img/195_thumb_G_1511571690703.jpg"  alt="西王花生油" /></a></div>-->
      <ul>
                              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201711/goods_img/195_P_1511571690429.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201711/goods_img/195_P_1511571690055.jpg"/></a></li>
                      <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://zy.jianzhanzhuanjia.net/images/201711/goods_img/195_P_1511571690158.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(195)" style="display: inline;"></a>
  <div class="title">
    <h1> 西王花生油 </h1>
  </div>
    <div class="title">
  ...
  <ul>
        <li>本店售价：<b class="price">￥<span>139.00</span></b>　    <del>原价：￥<span>139.00</span></del>
    </li>
    	    <li>
	注册用户：<b class="price" >￥<span>139.00</span></b></li>
  </ul>
  <ul>
...
var myString=new Array();
	   ...
	   <span class="ui-number radius5" style="float:left;">
            ...
            <input class="num" name="number" id="goods_number" autocomplete="off" value="1" min="1" max="9996" type="text" />
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(195)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(195);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://zy.jianzhanzhuanjia.net/images/201711/source_img/195_G_1511571690648.jpg"> </div>
            <div id="right">
              <p>西王花生油</p>
...
.spxq_main table td div, .spxq_main table td span {
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:195;}554fcae493e564ee0dc75bdf2ebf94ca</div>
 </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1515390175,
    nonceStr: 'w3gwpfKP5gfp6eQZ',
    signature: 'd19c28841153add75e8c508fc87244d1379fdca4',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      title: '西王花生油',
      desc: '西王花生油',
      link: 'http://zy.jianzhanzhuanjia.net/mobile/index.php?u=33',
      imgUrl: 'http://zy.jianzhanzhuanjia.net/images/201711/source_img/195_G_1511571690648.jpg',
      trigger: function (res) {
		        alert('恭喜！分享可以获取提成哦！');
		
      },
      success: function (res) {
		        window.location.href="http://zy.jianzhanzhuanjia.net/mobile/re_url.php?user_id=33&type=1";
		      },
      cancel: function (res) {
        alert('很遗憾，您已取消分享');
      },
    ...
    wx.onMenuShareTimeline({
      ...
      success: function (res) {
       	        window.location.href="http://zy.jianzhanzhuanjia.net/mobile/re_url.php?user_id=33&type=2";
		      },
      cancel: function (res) {
         alert('很遗憾，您已取消分享');
      },
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(195)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(195);">加入购物车</button>
