<?php exit;?>a:3:{s:8:"template";a:3:{i:0;s:52:"/var/www/ecshop/mobile/themes/ocailong_com/goods.dwt";i:1;s:63:"/var/www/ecshop/mobile/themes/ocailong_com/library/comments.lbi";i:2;s:66:"/var/www/ecshop/mobile/themes/ocailong_com/library/page_footer.lbi";}s:7:"expires";i:1510824906;s:8:"maketime";i:1510821306;}<!DOCTYPE html>
<html>
<head>
<meta name="Generator" content="ECSHOP v2.7.3" />
<meta content="text/html; charset=utf-8" http-equiv="Content-Type" />
<meta charset="utf-8" />
<title>日本蒜蓉粉丝扇贝270克6只装_根茎类_生鲜食品_ 触屏版</title>
...
<section class="goods_slider">
  <div id="slideBox" class="slideBox">
    <div class="scroller"> 
      <!--<div><a href="javascript:showPic()"><img src="images/201512/thumb_img/47_thumb_G_1448946213633.jpg"  alt="日本蒜蓉粉丝扇贝270克6只装" /></a></div>-->
      <ul>
         
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/47_P_1448946213263.jpg"/></a></li>
         
              <li><a href="javascript:showPic()"><img style="width:auto;height:20rem;" src="http://ecshop.dev/images/201512/goods_img/47_P_1448946213157.jpg"/></a></li>
                      </ul>
    </div>
    <div class="icons">
      <ul>
...
<section class="goodsInfo">
  <a class="collect" id="collect_box" href="javascript:collect(47)" style="display: inline;"></a>
  <div class="title">
    <h1> 日本蒜蓉粉丝扇贝270克6只装 </h1>
  </div>
    <div class="title">
     
  </div>
  <ul>
        <li>促销价：<b class="price">￥<span>108</span></b>　    <del>￥<span>156</span></del> 
    </li> 
     
	    <li>	
	注册用户：<b class="price" >￥<span>130</span></b></li>
  </ul>
...
var myString=new Array();
	 ...
	 <!--
        <button type="button" class="btn buy radius5" onClick="addToCart_quick(47)">立即购买</button>
        <button type="button" class="btn cart radius5" onclick="addToCart(47);">
        ...
        <div class="popGeneral" id="popDiv" >
          ...
          <div id="main">
            <div id="left"> <img width="115" height="115" src="http://ecshop.dev/images/201512/source_img/47_G_1448946213757.jpg"> </div>
            <div id="right">
              <p>日本蒜蓉粉丝扇贝270克6只装</p>
...
<img width="790" height="602" src="http://ecshop.dev/images/upload/Image/3.jpg" alt="" /></p>	      </div>
  ...
  <div id="tab2" class="hidden">
    <div class="wrap">
      <div class="blank2"></div>
      <script type="text/javascript" src="data/static/js/transportjq.js"></script><script type="text/javascript" src="data/static/js/utils.js"></script><div id="ECS_COMMENT"> 554fcae493e564ee0dc75bdf2ebf94cacomments|a:3:{s:4:"name";s:8:"comments";s:4:"type";i:0;s:2:"id";i:47;}554fcae493e564ee0dc75bdf2ebf94ca</div> </div>
  </div>
...
<script>
  wx.config({
    debug: false,
    appId: '',
    timestamp: 1510821306,
    nonceStr: 'vXX1KVqGmUK3OVzs',
    signature: '046e89bd205462af408647e796ee3efd7d5a7f2a',
    jsApiList: [
        'onMenuShareTimeline',
 ...
 wx.ready(function () {
    ...
    wx.onMenuShareAppMessage({
      ...
      desc: '日本蒜蓉粉丝扇贝270克6只装',
      link: 'http://ecshop.dev/mobile/index.php?u=12',
      imgUrl: 'http://ecshop.dev/images/201512/source_img/47_G_1448946213757.jpg',
...
<section id="s-action" class="s-action float">
    <button class="buy" type="button" onclick="addToCart_quick(47)">立刻购买</button>
    <button class="cart" type="button" onclick="addToCart(47);">加入购物车</button>
