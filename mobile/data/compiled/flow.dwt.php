...
?>
        ...
        <dl id="zitidian" style="display:none">
          <dd class="dd1"><span class="span1 radius5">自提点:</span></dd>
          <dd class="dd2" id="picktxt1">请选择自提点</dd>
          <i></i>
        </dl>
        <div class="dl_box" id="picktxt" style="display:none">
		</div>
        <?php else: ?>
...
?>
    ...
    <?php endif; ?>
    <?php if ($this->_var['consume_jiubi']): ?>
    <div class="dl_box">
          <dl>
            <dd>使用储值卡金额</dd>
     ...
     <?php if ($this->_var['isVipMoney']): ?>
     <div class="dl_box">
           <dl>
             <dd>使用vip金额</dd>
             <dd class="weiruan " bgcolor="#ffffff"><input name="vipMoney" type="text" class="input" id="ECS_VIP_MONEY" onblur="changeVipMoney(this.value)" value="<?php echo empty($this->_var['vipUsableMoney']) ? '0' : $this->_var['vipUsableMoney']; ?>" size="10" />            </dd>
           </dl>
      </div>
      <div class="dl_box">
           <dl>
             <dd>您当前可用VIP余额:<?php echo empty($this->_var['user_info']['vip_money']) ? '0' : $this->_var['user_info']['vip_money']; ?> .
               <span id="ECS_VIP_MONEY_NOTICE" class="notice"></span>
             </dd>
         </dl>
      </div>
    <?php endif; ?>
