        ...
        <div class="pro-inner">
          ...
          <div class="proInfo-wrap">
            ...
            <div class="proPrice">
              ...
              <?php endif; ?>
              <del style="color:#878D99"><?php echo $this->_var['goods']['market_price']; ?></del>
            </div>
            <div class="proService">可用储值卡:<span style="color:#EB9E05"> <?php echo $this->_var['goods']['jiubi']; ?> </span></div>
