...
{
    if (document.getElementById('picktxt1')&&result.picktxt) {
        $('#zitidian').show()
        document.getElementById('picktxt1').innerHTML = result.picktxt;
    }else{
        document.getElementById('picktxt1').innerHTML = '请选择自提点';
        $('#zitidian').hide()
    }
...
function selectShipping_pinfo(ojb){
    var name = ojb.attributes['pinfo_name'].value
    var id = ojb.value
    document.getElementById('picktxt1').innerHTML = name+'<input type="hidden" id="point0" name="pickup_point[0]" value="'+id+'">';
    $('#picktxt').slideToggle("fast");
}
