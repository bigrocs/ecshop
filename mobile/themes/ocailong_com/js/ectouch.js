...
$(function(){
	...
	*/
	...
	//门店自提
	$('#picktxt1').click(function(){
		   $('#picktxt').slideToggle("fast");
		   var suppid = 0;
		   var pid = $('#point'+suppid).val();
		   Ajax.call('flow.php?step=select_pickinfo', 'sid=0&pid='+pid, pickinfo, 'POST', 'JSON');
	});
	function pickinfo(result){
		document.getElementById('picktxt').innerHTML = result.content;
	}
