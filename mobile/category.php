...
if (!$smarty->is_cached('category.dwt', $cache_id)) {
    ...
    if ($_GET['act'] == 'asynclist') {
        ...
        <div class="proInfo-wrap">
          ...
          <div class="marketPrice"><del style="color:#878D99;">'.$vo['market_price'].'</del></div>
          <div class="proChuZhiKa">可用储值卡:<span style="color:#EB9E05"> '.$vo['jiubi'].'</span></div>
...
function category_get_goods($children, $brand, $min, $max, $ext, $size, $page, $sort, $order)
{
    ...
    while ($row = $GLOBALS['db']->fetchRow($res)) {
        ...
        $arr[$row['goods_id']]['jiubi']             = $row['jiubi'];
